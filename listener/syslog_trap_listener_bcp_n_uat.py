...
=============================================================================
  ...
  Location pair: BCP + UAT  (one SANnav forwards both DCs to this VM)
=============================================================================

Self-contained listener for the BCP+UAT Brocade SAN pipeline. Engine logic
and the switch inventory for *both* BCP and UAT live in this single file;
...
Wire format observed on UDP/TCP 515 (RFC5424, BOM-prefixed message body):
  ...
  <PRI>1 TIMESTAMP HOSTNAME APPNAME PROCID - \\
       ...
       [swname@1588   value="NETM_X7_113_FAB1"]    \\
       [...]                                        \\
...
Configuration overrides (typical: /etc/hi-track/listener.bcp_n_uat.env):
...
TEST_DEFAULT_IP = os.environ.get("HITRACK_TEST_DEFAULT_IP", "10.225.49.221")
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("syslog_trap_listener_bcp_n_uat.log"),
    ],
)
log = logging.getLogger("syslog_trap_listener_bcp_n_uat")

raw_log = logging.getLogger("raw_syslog_bcp_n_uat")
raw_log.setLevel(logging.INFO)
raw_fh = logging.FileHandler("syslog_trap_listener_bcp_n_uat_raw_syslog_data.log")
...
#
# SANNAV_SOURCES   : IP -> SANnav hostname. The ONLY source IPs accepted
#                    by the listener (everything else is dropped).
# SWITCH_INFO      : NORMALISED switch name -> (environment, owner, model).
#                    Looked up against `swname@1588` from the SD block.
# SWITCH_IP_TO_NAME: optional reverse map used as a last-ditch fallback if
#                    SD has no swname AND a packet somehow arrives with the
#                    original switch IP as source. Also serves as inventory
#                    documentation.
# ---------------------------------------------------------------------------
...
SWITCH_INFO: dict[str, tuple] = {
    # --------------------- BCP (NTT Bangalore) ---------------------------
    "BGLR_7840_HUR_FAB1":     ("BCP", "Hitachi", "7840 FCIP Switch"),
    "BGLR_7840_HUR_FAB2":     ("BCP", "Hitachi", "7840 FCIP Switch"),
    "BGLR_5FL_7840_HUR_FAB1": ("BCP", "Hitachi", "7840 FCIP Switch"),
    "BGLR_5FL_7840_HUR_FAB2": ("BCP", "Hitachi", "7840 FCIP Switch"),

    "NETM_X6_101_FAB1": ("BCP", "Netapp",  "DCX X6-8"),
    "NETM_X6_102_FAB2": ("BCP", "Netapp",  "DCX X6-8"),
    "NETM_X6_103_FAB1": ("BCP", "Netapp",  "DCX X6-8"),
    "NETM_X6_104_FAB2": ("BCP", "Netapp",  "DCX X6-8"),
    "NETM_X6_107_FAB1": ("BCP", "Netapp",  "DCX X6-8"),
    "NETM_X6_108_FAB2": ("BCP", "Netapp",  "DCX X6-8"),

    "NETM_X7_111_FAB1": ("BCP", "Netapp",  "DCX X7-8"),
    "NETM_X7_112_FAB2": ("BCP", "Netapp",  "DCX X7-8"),
    "NETM_X7_113_FAB1": ("BCP", "Netapp",  "DCX X7-8"),
    "NETM_X7_114_FAB2": ("BCP", "Netapp",  "DCX X7-8"),
    "NETM_X7_115_FAB1": ("BCP", "Netapp",  "DCX X7-8"),
    "NETM_X7_116_FAB2": ("BCP", "Netapp",  "DCX X7-8"),
    "NETM_X7_117_FAB1": ("BCP", "Hitachi", "DCX X7-8"),
    "NETM_X7_118_FAB2": ("BCP", "Hitachi", "DCX X7-8"),
    "NETM_X7_119_FAB1": ("BCP", "Hitachi", "DCX X7-8"),
    "NETM_X7_120_FAB2": ("BCP", "Hitachi", "DCX X7-8"),
    "NETM_X7_121_FAB1": ("BCP", "Netapp",  "DCX X7-8"),
    "NETM_X7_122_FAB2": ("BCP", "Netapp",  "DCX X7-8"),
    "NETM_X7_123_FAB1": ("BCP", "Netapp",  "DCX X7-8"),
    "NETM_X7_124_FAB2": ("BCP", "Netapp",  "DCX X7-8"),

    # The two un-named DCX X7-8 / Hitachi switches on 10.65.8.166-168
    # and 10.65.8.169-171. Replace these placeholder names once the real
    # switch names are confirmed; SD swname will then resolve cleanly.
    "BCP_X7_UNNAMED_FAB1": ("BCP", "Hitachi", "DCX X7-8"),
    "BCP_X7_UNNAMED_FAB2": ("BCP", "Hitachi", "DCX X7-8"),

    # --------------------- UAT (NTT Chandivali UAT) ----------------------
    "NTTC_X6_UAT_101_FAB1": ("UAT", "Netapp", "DCX X6-8"),
    "NTTC_X6_UAT_102_FAB2": ("UAT", "Netapp", "DCX X6-8"),
    "NTTC_X6_UAT_103_FAB1": ("UAT", "Netapp", "DCX X6-8"),
    "NTTC_X6_UAT_104_FAB2": ("UAT", "Netapp", "DCX X6-8"),
    "NTTC_X6_UAT_105_FAB1": ("UAT", "Netapp", "DCX X6-8"),
    "NTTC_X6_UAT_106_FAB2": ("UAT", "Netapp", "DCX X6-8"),
    "NTTC_X7_UAT_109_FAB1": ("UAT", "Netapp", "DCX X7-8"),
    "NTTC_X7_UAT_110_FAB2": ("UAT", "Netapp", "DCX X7-8"),
}


SWITCH_IP_TO_NAME: dict[str, str] = {
    # --------------------- BCP -------------------------------------------
    "10.65.12.96":  "BGLR_7840_HUR_FAB1",
    "10.65.12.97":  "BGLR_7840_HUR_FAB2",
    "10.65.15.1":   "BGLR_5FL_7840_HUR_FAB1",
    "10.65.15.2":   "BGLR_5FL_7840_HUR_FAB2",

    "10.65.4.76":   "NETM_X6_101_FAB1",
    "10.65.4.121":  "NETM_X6_102_FAB2",
    "10.65.4.85":   "NETM_X6_103_FAB1",
    "10.65.4.88":   "NETM_X6_104_FAB2",
    "10.65.4.239":  "NETM_X6_107_FAB1",
    "10.65.4.242":  "NETM_X6_108_FAB2",

    "10.65.6.84":   "NETM_X7_111_FAB1",
    "10.65.6.85":   "NETM_X7_111_FAB1",
    "10.65.6.86":   "NETM_X7_111_FAB1",
    "10.65.6.87":   "NETM_X7_112_FAB2",
    "10.65.6.88":   "NETM_X7_112_FAB2",
    "10.65.6.89":   "NETM_X7_112_FAB2",

    "10.65.7.171":  "NETM_X7_113_FAB1",
    "10.65.7.172":  "NETM_X7_113_FAB1",
    "10.65.7.173":  "NETM_X7_113_FAB1",
    "10.65.7.174":  "NETM_X7_114_FAB2",
    "10.65.7.175":  "NETM_X7_114_FAB2",
    "10.65.7.176":  "NETM_X7_114_FAB2",
    "10.65.7.177":  "NETM_X7_115_FAB1",
    "10.65.7.178":  "NETM_X7_115_FAB1",
    "10.65.7.179":  "NETM_X7_115_FAB1",
    "10.65.7.180":  "NETM_X7_116_FAB2",
    "10.65.7.181":  "NETM_X7_116_FAB2",
    "10.65.7.182":  "NETM_X7_116_FAB2",

    "10.65.13.95":  "NETM_X7_117_FAB1",
    "10.65.13.92":  "NETM_X7_118_FAB2",
    "10.65.13.102": "NETM_X7_119_FAB1",
    "10.65.13.103": "NETM_X7_119_FAB1",
    "10.65.13.104": "NETM_X7_119_FAB1",
    "10.65.13.105": "NETM_X7_120_FAB2",
    "10.65.13.106": "NETM_X7_120_FAB2",
    "10.65.13.107": "NETM_X7_120_FAB2",

    "10.65.15.225": "NETM_X7_121_FAB1",
    "10.65.15.228": "NETM_X7_122_FAB2",
    "10.65.15.197": "NETM_X7_123_FAB1",
    "10.65.15.200": "NETM_X7_124_FAB2",

    "10.65.8.166":  "BCP_X7_UNNAMED_FAB1",
    "10.65.8.167":  "BCP_X7_UNNAMED_FAB1",
    "10.65.8.168":  "BCP_X7_UNNAMED_FAB1",
    "10.65.8.169":  "BCP_X7_UNNAMED_FAB2",
    "10.65.8.170":  "BCP_X7_UNNAMED_FAB2",
    "10.65.8.171":  "BCP_X7_UNNAMED_FAB2",

    # --------------------- UAT -------------------------------------------
    "10.229.196.9":   "NTTC_X6_UAT_101_FAB1",
    "10.229.196.12":  "NTTC_X6_UAT_102_FAB2",
    "10.229.196.15":  "NTTC_X6_UAT_103_FAB1",
    "10.229.196.18":  "NTTC_X6_UAT_104_FAB2",
    "10.229.197.78":  "NTTC_X6_UAT_105_FAB1",
    "10.229.197.81":  "NTTC_X6_UAT_106_FAB2",

    "10.226.196.235": "NTTC_X7_UAT_109_FAB1",
    "10.226.196.236": "NTTC_X7_UAT_109_FAB1",
    "10.226.196.237": "NTTC_X7_UAT_109_FAB1",
    "10.226.196.238": "NTTC_X7_UAT_110_FAB2",
    "10.226.196.239": "NTTC_X7_UAT_110_FAB2",
    "10.226.196.240": "NTTC_X7_UAT_110_FAB2",
}
...
# RFC5424 with one or more SD blocks (SANnav emits 5+ adjacent SD blocks,
# each carrying a single key/value pair).
...
# SANnav SD format:  [<key>@<enterprise_id> value="<value>"]
...
# Module -> human-readable subsystem (from the FOS Message Reference).
BRCD_MODULE_LABEL = {
...
# the message text mentions a more specific subsystem.
...
# longest-match-first via lookup_sannav_category() so that "SSMP-AUTH"
# wins over the bare "SSMP".
...
# Trap-category keyword detectors. Order matters: most specific buckets win.
...
# Per-message severity catalogue from the FOS 9.2.x Message Reference.
# Used only to enrich the trap when SANnav strips/normalises the SD severity.
...
# Plain "[MODULE-CODE]" embedded in a free-form RASLog body.
...
def split_alert_id(alert_id):
    """Return (module_first, module_full, code) or (None, None, None)."""
    if not alert_id:
...
def parse_alert_from_sd(sd, msg_text):
    """Build an alert payload from SANnav structured-data + message body."""
    if not sd:
        return None
    ...
    if module_first is None:
        # Unparseable msgid - keep as opaque token, treat as SANnav event.
...
# ---------------------------------------------------------------------------
# Brocade RASLog fallback parser. SANnav normally splits the RASLog into SD
# fields, but if a switch ever sends RASLog text directly we still cope.
# ---------------------------------------------------------------------------
...
def main():
    bcp_count  = sum(1 for v in SWITCH_INFO.values() if v[0] == "BCP")
    uat_count  = sum(1 for v in SWITCH_INFO.values() if v[0] == "UAT")
    other      = len(SWITCH_INFO) - bcp_count - uat_count
    ...
    log.info(" Switch inventory    : %d total (BCP=%d, UAT=%d, other=%d)",
             len(SWITCH_INFO), bcp_count, uat_count, other)
