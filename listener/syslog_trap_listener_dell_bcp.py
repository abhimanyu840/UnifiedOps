...
"""
=============================================================================
  SNMP Trap Listener -> InfluxDB v2  (Hi-Track / HDFC -- BCP Dell pipeline)
=============================================================================

Self-contained SNMP trap receiver for the BCP Dell storage
...
def main() -> None:
    log.info("=" * 64)
    log.info(f" SNMP Trap Listener (BCP) - starting up")
