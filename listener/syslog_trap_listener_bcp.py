...
"""
=============================================================================
  Syslog Trap Listener -> InfluxDB v2  (Hi-Track / HDFC -- BCP pipeline)
=============================================================================

Self-contained listener for the BCP location. The engine logic and the
BCP IP maps live in this single file - no shared modules, no other
location referenced.

Configuration overrides (typical: /etc/hi-track/listener.bcp.env):

    HITRACK_INFLUX_URL      default http://127.0.0.1:8086
    HITRACK_INFLUX_TOKEN    *** required for writes ***
    HITRACK_INFLUX_ORG      default HDFC
    HITRACK_INFLUX_BUCKET   default SYSLOG_HIT_BCP_Bucket
...
INFLUX_BUCKET = os.environ.get("HITRACK_INFLUX_BUCKET", "SYSLOG_HIT_BCP_Bucket")
...
TEST_DEFAULT_IP = os.environ.get("HITRACK_TEST_DEFAULT_IP", "10.65.4.112")
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("syslog_trap_listener_bcp.log"),
    ],
)
log = logging.getLogger("syslog_trap_listener_bcp")

raw_log = logging.getLogger("raw_syslog_bcp")
raw_log.setLevel(logging.INFO)
raw_fh = logging.FileHandler("syslog_trap_listener_bcp_raw_syslog_data.log")
...
# ---------------------------------------------------------------------------
# IP MAPPINGS (BCP only)
# Source IP -> measurement bucket. Anything not listed is dropped at the
# source by classify_source().
# ---------------------------------------------------------------------------
IP_FILTER: dict[str, str] = {
    "10.65.4.112":   "modular_storage",
    "10.65.4.113":   "modular_storage",
    "10.65.4.114":   "modular_storage",
    "10.65.4.115":   "modular_storage",
    "10.65.4.116":   "modular_storage",
    "10.65.4.117":   "modular_storage",
    "10.65.4.89":    "modular_storage",
    "10.65.4.90":    "modular_storage",
    "10.65.4.91":    "modular_storage",
    "10.65.4.92":    "modular_storage",
    "10.65.4.93":    "modular_storage",
    "10.65.4.94":    "modular_storage",
    "10.65.5.5":     "modular_storage",
    "10.65.5.223":   "modular_storage",
    "10.65.5.224":   "modular_storage",
    "10.65.5.6":     "modular_storage",
    "10.65.7.184":   "modular_storage",
    "10.65.7.185":   "modular_storage",
    "10.65.5.7":     "modular_storage",
    "10.65.4.8":     "modular_storage",
    "10.65.4.9":     "modular_storage",
    "10.225.72.140": "modular_storage",
    "10.225.72.108": "modular_storage",
    "10.225.72.109": "modular_storage",
    "10.225.72.139": "modular_storage",
    "10.225.72.111": "modular_storage",
    "10.225.72.112": "modular_storage",
    "10.225.72.144": "modular_storage",
    "10.225.72.114": "modular_storage",
    "10.225.72.115": "modular_storage",
    "10.225.72.142": "modular_storage",
    "10.225.72.117": "modular_storage",
    "10.225.72.118": "modular_storage",
    "10.225.72.145": "modular_storage",
    "10.225.72.120": "modular_storage",
    "10.225.72.121": "modular_storage",
    "10.225.72.146": "modular_storage",
    "10.225.72.123": "modular_storage",
    "10.225.72.124": "modular_storage",
    "10.225.72.147": "modular_storage",
    "10.225.72.126": "modular_storage",
    "10.225.72.127": "modular_storage",
    "10.225.51.219": "modular_storage",
    "10.225.51.53":  "modular_storage",
    "10.225.51.54":  "modular_storage",

    "10.65.15.147":  "enterprise_storage",
    "10.65.15.148":  "enterprise_storage",
    "10.225.39.253": "enterprise_storage",
    "10.225.39.254": "enterprise_storage",
    "10.65.4.99":    "enterprise_storage",
    "10.65.13.200":  "enterprise_storage",
    "10.65.12.189":  "enterprise_storage",
    "10.65.14.241":  "enterprise_storage",
    "10.65.14.103":  "enterprise_storage",
}

# ---------------------------------------------------------------------------
# IP -> friendly storage name (BCP only).
# ---------------------------------------------------------------------------
